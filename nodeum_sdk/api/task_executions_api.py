...
class TaskExecutionsApi(object):
    ...
    def index_task_executions_by_task(self, **kwargs):  # noqa: E501
        ...
        **API Key Scope**: task_executions / index  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.index_task_executions_by_task(task_id=task_id_value, async_req=True)
        >>> result = thread.get()
    ...
    def index_task_executions_by_task_with_http_info(self, **kwargs):  # noqa: E501
        ...
        **API Key Scope**: task_executions / index  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.index_task_executions_by_task_with_http_info(task_id=task_id_value, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('task_id' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `task_id` when calling `index_task_executions_by_task`")  # noqa: E501
