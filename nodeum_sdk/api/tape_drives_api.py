...
class TapeDrivesApi(object):
    ...
    def index_tape_drive_devices(self, **kwargs):  # noqa: E501
        ...
        **API Key Scope**: tape_drives / devices  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.index_tape_drive_devices(tape_library_id=tape_library_id_value, async_req=True)
        >>> result = thread.get()
    ...
    def index_tape_drive_devices_with_http_info(self, **kwargs):  # noqa: E501
        ...
        **API Key Scope**: tape_drives / devices  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.index_tape_drive_devices_with_http_info(tape_library_id=tape_library_id_value, async_req=True)
        >>> result = thread.get()
