...
class NodeumFileWithPath(object):
    ...
    def __init__(self, id=None, name=None, parent=None, type=None, permission=None, size=None, change_date=None, modification_date=None, access_date=None, uid=None, gid=None, file_path=None, local_vars_configuration=None):  # noqa: E501
