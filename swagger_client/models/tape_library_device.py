...
class TapeLibraryDevice(object):
    ...
    def __init__(self, serial=None, protocol=None, vendor=None, product=None, firmware=None, device=None, acs=None, storage_slots=None, storage_slots_address=None, io_slots=None, io_slots_address=None):  # noqa: E501
        """TapeLibraryDevice - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TapeLibraryDevice, dict):
