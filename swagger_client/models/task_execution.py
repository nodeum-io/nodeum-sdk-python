...
class TaskExecution(object):
    ...
    def __init__(self, id=None, task_id=None, name=None, type=None, status=None, log_time=None, job_started=None, job_finished=None, to_process_size=None, processed_size=None, to_process_files=None, processed_files=None, finalized_files=None, estimation_time=None, bandwidth=None):  # noqa: E501
